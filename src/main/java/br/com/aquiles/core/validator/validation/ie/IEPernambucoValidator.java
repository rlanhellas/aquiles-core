...
public class IEPernambucoValidator implements Validator<String> {
    ...
    public IEPernambucoValidator(MessageProducer messageProducer, boolean isFormatted) {
		Class[] validatorClasses = { IEPernambucoNovaValidator.class, br.com.aquiles.core.validator.validation.ie.IEPernambucoAntigaValidator.class };
	 ...
	 * @return uma inscricao estadual valida de acordo com o novo padrão de Pernambuco
	 */
	@Override
