...
public class LogicOrComposedValidator<T> implements Validator<T> {
    ...
    public LogicOrComposedValidator(MessageProducer messageProducer, boolean isFormatted,
        ...
        if (validatorClasses.length == 0) {
            throw new IllegalArgumentException(
                    "Ao menos um validador deve ser passado como argumento na construcao");
        }
    ...
    public void assertValid(T value) {
        br.com.aquiles.core.validator.validation.InvalidStateException lastException = null;
        ...
        for (Validator<T> v : validators) {
            if (v.isEligible(value)) {
                try {
                    ...
                    isValid = true;
                    break;
                } catch (br.com.aquiles.core.validator.validation.InvalidStateException e) {
                    lastException = e;
                }
            }
        }
	 ...
	 * @return um documento valido de acordo com as regras do primeiro validador passado como
	 *         argumento na construcao deste validador
	 */
    @Override
