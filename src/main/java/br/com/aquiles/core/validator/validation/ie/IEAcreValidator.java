 ...
 * </p>
 * <ul>
 * <li><a href="http://www.sefaz.al.gov.br/sintegra/cad_AC.asp">ROTEIRO DE CRITICA DA INSCRIcao
 * ESTADUAL</a>
 * <li><a href="http://www.sintegra.gov.br/Cad_Estados/cad_AC.html">SINTEGRA - ROTEIRO DE
 * CRITICA DA INSCRIcao ESTADUAL</a>
 * </ul>
 * 
 */
public class IEAcreValidator extends AbstractIEValidator {
	...
	public String generateRandomValid() {
		final String ieSemDigitos = "01" + new DigitoGerador().generate(9);
