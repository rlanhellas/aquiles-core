...
/**
 * Responsavel por transformar um número em sua representacao por extenso.
 */
public class NumericToWordsConverter {

    private final br.com.aquiles.core.validator.inword.FormatoDeExtenso formato;
	private final Locale locale;

    /**
     * @param formato
     *            formato desejado para a transformacao por extenso
     */
    public NumericToWordsConverter(br.com.aquiles.core.validator.inword.FormatoDeExtenso formato) {
     ...
     *            formato desejado para a transformacao por extenso
     * @param locale
     *            idioma desejado para a transformacao por extenso
     */
     ...
     * @return Representacao do número por extenso.
     */
    public String toWords(long number) {
        try {
            if (number < 0) {
                throw new IllegalArgumentException("Não é possIvel transformar números negativos.");
            }
    ...
    private final class ThousandBlock {
        ...
        public String toWords() {
            String result;
            if (numberValue <= 20) {
                result = br.com.aquiles.core.validator.inword.NumericToWordsConverter.this.getNumber(numberValue);
            } else if (numberValue <= 99) {
                result = getNumberUnder100(numberValue);
            } else if (numberValue == 100) {
                result = br.com.aquiles.core.validator.inword.NumericToWordsConverter.this.getNumber(100);
            } else {
                int c = (numberValue / 100) * 100;
                String centena;
                if (c == 100) {
                    centena = br.com.aquiles.core.validator.inword.NumericToWordsConverter.this.getString("100+?");
                } else {
                    centena = br.com.aquiles.core.validator.inword.NumericToWordsConverter.this.getNumber(c);
                }
